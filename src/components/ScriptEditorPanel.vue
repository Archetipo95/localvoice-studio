...
<template>
  ...
  >
    <div class="flex items-center border-b border-muted/80 bg-default/90">
      <UEditorToolbar
        :editor="editor"
        :items="toolbarItems"
        layout="fixed"
        ...
        class="px-2 py-1 overflow-x-auto flex-1 [&_[role=separator]]:bg-muted [&_[role=separator]]:opacity-100 [&_[class*='divide-x']>*+*]:border-muted/90 [&_.border-l]:border-muted/90"
      />
      <div class="flex items-center gap-2 px-2 shrink-0 text-toned" aria-label="Toggle markup view">
